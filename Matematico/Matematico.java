...
public class Matematico
{
    public String DeterminarElMayorMenorEIgual(double n1,double n2,double n3){
        if((n1>n2) && (n1>n3)){
            return "El mayor es el primer numero"+n1;
        }
        if((n2<n1) && (n2>n3)){
            return "El numero que le sigue en la comparacion es "+n2;
        }
        if((n3<n1)&&(n3<n2)){
            return "El mayor es el primer numero"+n1;
        }
        if ((n1==n3)|| (n2==n3) || (n1==n2)){
         return "Coloco un numero que es igual a otro dentro de la comparacion \n porfavor cambielo";
        }else{
            return "coloco un dato que no es double";
        }
    }
